...
void CallbackDirectory::call(quint64 requestId, const QVariant &result)
{
...
void CallbackDirectory::call(quint64 requestId, const QString &result)
{
    CallbackSharedDataPointer sharedPtr = m_callbackMap.take(requestId);
    if (sharedPtr) {
...
void CallbackDirectory::call(quint64 requestId, bool result)
{
    CallbackSharedDataPointer sharedPtr = m_callbackMap.take(requestId);
    if (sharedPtr) {
...
{
    m_callbacks.call(requestId, result);
}
...
{
    m_callbacks.call(requestId, matchCount > 0);
}
