...
public:
    QQuickWebEngineHistoryListModelPrivate(WebContentsAdapter*);
...
public:
    QQuickWebEngineBackForwardHistoryListModelPrivate(WebContentsAdapter*);
...
public:
    QQuickWebEngineBackHistoryListModelPrivate(WebContentsAdapter*);
...
public:
    QQuickWebEngineForwardHistoryListModelPrivate(WebContentsAdapter*);
...
public:
    QQuickWebEngineHistoryPrivate(WebContentsAdapter*);
