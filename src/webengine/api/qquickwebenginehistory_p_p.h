...
typedef QList<WebEngineHistoryItem> (WebEngineHistory::*itemsFunctionPointer)(void) const;

class QQuickWebEngineHistoryListModelPrivate {
public:
    QQuickWebEngineHistoryListModelPrivate(const QExplicitlySharedDataPointer<WebEngineHistory>&, itemsFunctionPointer);
