...
public:
    QWebEngineLoadRequestPrivate(const QUrl& url, QQuickWebEngineView::LoadStatus status, const QString& errorString, int errorCode, QQuickWebEngineView::ErrorDomain errorDomain)
        : url(url)
        , status(status)
...
/*!
    ...
    \sa WebView::onLoadingStateChanged
*/
QWebEngineLoadRequest::QWebEngineLoadRequest(const QUrl& url, QQuickWebEngineView::LoadStatus status, const QString& errorString, int errorCode, QQuickWebEngineView::ErrorDomain errorDomain, QObject* parent)
    : QObject(parent)
    , d(new QWebEngineLoadRequestPrivate(url, status, errorString, errorCode, errorDomain))
{
}
...
*/
QQuickWebEngineView::LoadStatus QWebEngineLoadRequest::status() const
{
    return d->status;
}
...
QQuickWebEngineView::ErrorDomain QWebEngineLoadRequest::errorDomain() const
{
