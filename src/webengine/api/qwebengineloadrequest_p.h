...
public:
    QWebEngineLoadRequest(const QUrl& url, QQuickWebEngineView::LoadStatus status, const QString& errorString = QString(), QQuickWebEngineView::ErrorDomain errorDomain = QQuickWebEngineView::NoErrorDomain, int errorCode = 0, QObject* parent = 0);
