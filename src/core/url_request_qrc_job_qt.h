...
public:
    URLRequestQrcJobQt(net::URLRequest* request, net::NetworkDelegate* network_delegate);
    virtual void Start() Q_DECL_OVERRIDE;
    virtual void Kill() Q_DECL_OVERRIDE;
    virtual bool ReadRawData(net::IOBuffer* buf, int buf_size, int *bytes_read) Q_DECL_OVERRIDE;
    virtual bool GetMimeType(std::string* mime_type) const Q_DECL_OVERRIDE;
...
private:
    ...
    base::WeakPtrFactory<URLRequestQrcJobQt> weak_factory_;
