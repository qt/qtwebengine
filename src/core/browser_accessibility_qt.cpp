...
//    qDebug() << "Got role: " << BrowserAccessibility::role();
    ...
    case WebAXRoleTableHeaderContainer:
        return QAccessible::NoRole; // FIXME
    case WebAXRoleTabGroup:  // WebKit doesn't use (uses ROLE_TAB_LIST)
        return QAccessible::NoRole; // FIXME
...
{
    // FIXME this should probably never be called, but better check this
    Q_ASSERT_X(0, "", "BrowserAccessibilityQt::NativeReleaseReference got called");
