...
public:
    ...
    content::BrowserAccessibility *PlatformGetChild(size_t child_index) const override;
    content::BrowserAccessibility *PlatformGetFirstChild() const override;
    content::BrowserAccessibility *PlatformGetLastChild() const override;
    content::BrowserAccessibility *PlatformGetNextSibling() const override;
    content::BrowserAccessibility *PlatformGetPreviousSibling() const override;
#endif
...
content::BrowserAccessibility* BrowserAccessibilityQt::PlatformGetChild(size_t child_index) const
{
...
content::BrowserAccessibility* BrowserAccessibilityQt::PlatformGetFirstChild() const
{
    return PlatformGetChild(0);
}

content::BrowserAccessibility* BrowserAccessibilityQt::PlatformGetLastChild() const
{
    const std::vector<raw_ptr<ui::AXNode, VectorExperimental>>* extra_mac_nodes =
      node()->GetExtraMacNodes();
    if (extra_mac_nodes && !extra_mac_nodes->empty())
...
content::BrowserAccessibility* BrowserAccessibilityQt::PlatformGetNextSibling() const
{
...
content::BrowserAccessibility* BrowserAccessibilityQt::PlatformGetPreviousSibling() const
{
    BrowserAccessibility* parent = PlatformGetParent();
    if (parent) {
...
QAccessibleInterface *BrowserAccessibilityInterface::cellAt(int row, int column) const
{
    ...
    content::BrowserAccessibility *cell = q->manager()->GetFromAXNode(node);
    if (cell) {
        int extent = 1;
...
QAccessibleInterface *BrowserAccessibilityInterface::caption() const
{
    ...
    return caption ? content::toQAccessibleInterface(caption) : nullptr;
}
