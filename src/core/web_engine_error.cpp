...
WebEngineError::ErrorDomain WebEngineError::toQtErrorDomain(int error_code)
{
    switch (error_code) {
        ...
        case net::ERR_FTP_FAILED:
        case net::ERR_FTP_SERVICE_UNAVAILABLE:
        case net::ERR_FTP_TRANSFER_ABORTED:
        case net::ERR_FTP_FILE_BUSY:
        case net::ERR_FTP_SYNTAX_ERROR:
        case net::ERR_FTP_COMMAND_NOT_SUPPORTED:
        case net::ERR_FTP_BAD_COMMAND_SEQUENCE:
            return WebEngineError::DownloadErrorDomain;
        default:
