...
parser.add_argument('--os', nargs='*', help='Only valid with --upstream. Download additional platform specific dependencies (valid OSes are: android, win, mac)')
