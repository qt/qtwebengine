...
macro(append_build_type_setup)
    ...
    # quick hack to compile qtpdf on older andorid sdk
    if(ANDROID AND ${QT_COMPILER_VERSION_MAJOR} LESS 15)
        list(APPEND gnArgArg use_partition_alloc=false)
    else()
        list(APPEND gnArgArg use_partition_alloc=true)
    endif()
