...
{
    emit featurePermissionProvided(m_feature, QWebEnginePage::PermissionDeniedByUser);
}

void FeaturePermissionBar::permissionGranted()
{
    emit featurePermissionProvided(m_feature, QWebEnginePage::PermissionGrantedByUser);
}
