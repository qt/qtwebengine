...
{
    base::FilePath::StringType suggestedFilename = item->GetSuggestedFilename();
    ...
    QString suggestedFilePath = m_defaultDownloadDirectory.absoluteFilePath(fromFilePathString(suggestedFilename));
