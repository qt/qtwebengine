...
public:
    ...
    virtual bool Initialize(gfx::GLSurface *, gfx::GpuPreference) { Q_ASSERT(false); return false; }
    virtual void Destroy() { Q_ASSERT(false); }
    virtual bool MakeCurrent(gfx::GLSurface *) { Q_ASSERT(false); return false; }
    virtual void ReleaseCurrent(gfx::GLSurface *) { Q_ASSERT(false); }
    virtual bool IsCurrent(gfx::GLSurface *) { Q_ASSERT(false); return false; }
    virtual void SetSwapInterval(int) { Q_ASSERT(false); }
