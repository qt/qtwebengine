...
public:
    ...
    virtual bool Initialize(gfx::GLSurface* compatible_surface, gfx::GpuPreference gpu_preference) { return false; }
    virtual void Destroy() { }
    virtual bool MakeCurrent(gfx::GLSurface* surface) { return false; }
    virtual void ReleaseCurrent(gfx::GLSurface* surface) { }
    virtual bool IsCurrent(gfx::GLSurface* surface) { return false; }
