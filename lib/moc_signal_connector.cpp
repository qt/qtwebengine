/****************************************************************************
** Meta object code from reading C++ file 'signal_connector.h'
**
...
#error "The header file 'signal_connector.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SignalConnector_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 69, 6)
    ...
    "SignalConnector\0loadAddressFromAddressBar\0"
    "\0load\0url\0goBack\0goForward\0reload\0"
};
...
void SignalConnector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->loadAddressFromAddressBar(); break;
...
const QMetaObject SignalConnector::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SignalConnector.data,
      qt_meta_data_SignalConnector,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SignalConnector.stringdata))
