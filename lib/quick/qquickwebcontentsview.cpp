...
void QQuickWebContentsViewPrivate::adjustSize(RenderWidgetHostViewQtDelegate *viewDelegate)
{
    Q_Q(QQuickWebContentsView);
    static_cast<RenderWidgetHostViewQtDelegateQuick *>(viewDelegate)->setSize(QSizeF(q->width(), q->height()));
}
