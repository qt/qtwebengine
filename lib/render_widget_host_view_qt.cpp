...
void RenderWidgetHostViewQt::OnAccessibilityNotifications(const std::vector<AccessibilityHostMsg_NotificationParams>& notifications)
{
    CreateBrowserAccessibilityManagerIfNeeded();
    GetBrowserAccessibilityManager()->OnAccessibilityNotifications(notifications);
}
