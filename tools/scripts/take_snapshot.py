...
def isInChromiumBlacklist(file_path):
    ...
    if (file_path.startswith('android_webview')
        ...
        or (file_path.startswith('chrome/')
          ...
          and not file_path.startswith('chrome/browser/plugins/')
        ...
        or (file_path.startswith('third_party/')
          and (file_path.startswith('third_party/WebKit/LayoutTests')
            ...
            or file_path.startswith('third_party/dawn/third_party/dxc')
            or file_path.startswith('third_party/dawn/third_party/gn/webgpu-cts/')
            or file_path.startswith('third_party/dawn/third_party/khronos/EGL-Registry/specs/')
            or file_path.startswith('third_party/dawn/third_party/khronos/OpenGL-Registry/specs/')
            or file_path.startswith('third_party/depot_tools')
            or file_path.startswith('third_party/devtools-frontend/src/front_end/panels/timeline/fixtures/traces')
            or file_path.startswith('third_party/devtools-frontend/src/node_modules/esbuild')
            ...
            or file_path.startswith('third_party/llvm-libc')
            ...
            or file_path.startswith('third_party/speedometer')
        ...
        or (file_path.startswith('tools/')
          and (file_path.startswith('tools/android')
            or file_path.startswith('tools/clusterfuzz')
