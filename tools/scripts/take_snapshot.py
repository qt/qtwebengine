...
def isInChromiumBlacklist(file_path):
    ...
    if ( '_jni' in file_path
        ...
        or file_path.startswith('third_party/cygwin/lib')
        or file_path.startswith('third_party/cygwin/usr')
        or file_path.startswith('third_party/cygwin/bin/bison')
        or file_path.startswith('third_party/cygwin/bin/flex')
        or file_path.startswith('third_party/cygwin/bin/gperf')
        or file_path.startswith('third_party/cygwin/bin/iconv')
        or file_path.startswith('third_party/cygwin/bin/m4')
        or file_path.startswith('third_party/cygwin/bin/perl')
